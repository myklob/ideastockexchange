-- Fields added to existing tables via db:push without a migration.
-- All new columns are nullable or have defaults so they are safe to add to live data.

-- Belief: April 2026 template fields
...
-- Argument: display fields for the argument trees cell
...
-- Compromise: structured negotiation fields
...
-- New tables: fine-grained interests/values analysis (new template)
