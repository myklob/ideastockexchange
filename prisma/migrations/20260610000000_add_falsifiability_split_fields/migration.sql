-- AlterTable: add columns that were added to the schema via db push without migrations.

-- Belief: falsifiability split fields, net interpretation, header metadata
...
-- Argument: label, quote, and score fields
...
-- ObjectiveCriteria: measurement and tracking fields
...
-- ValuesAnalysis: divergence evidence and shift fields
...
-- InterestsAnalysis: primary pair fields (supporter and opponent)
...
-- Compromise: new template fields
