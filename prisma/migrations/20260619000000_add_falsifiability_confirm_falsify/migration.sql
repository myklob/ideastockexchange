-- AlterTable: add new optional columns to Argument (new template fields)
...
-- AlterTable: add new optional columns to Belief
...
-- AlterTable: ObjectiveCriteria — new template columns
...
-- AlterTable: ValuesAnalysis — new template columns
...
-- AlterTable: InterestsAnalysis — new template columns
