-- April 2026 template fields: columns added to schema.prisma in the belief-page
-- restructure (commit 53b8449) but never materialised into a migration.

-- Belief: two-sided Falsifiability Test fields
ALTER TABLE "Belief" ADD COLUMN "falsifiabilityConfirm" TEXT;
ALTER TABLE "Belief" ADD COLUMN "falsifiabilityFalsify" TEXT;

-- Belief: net-score interpretation line
ALTER TABLE "Belief" ADD COLUMN "netInterpretation" TEXT;

-- Belief: header metadata (plain-text lists, never rendered as links per Rule 5)
ALTER TABLE "Belief" ADD COLUMN "relatedBeliefs" TEXT;
ALTER TABLE "Belief" ADD COLUMN "supportsBeliefs" TEXT;

-- Argument: label, quote, and displayed score columns (new template)
...
-- ObjectiveCriteria: measurement, current-status, and target columns
...
-- ValuesAnalysis: divergence-evidence and what-would-shift columns
...
-- InterestsAnalysis: Primary Conflict Pair columns
...
-- Compromise: three-column Best Compromise Solutions form
...
-- New table: Shared Values, Different Rankings
...
-- New table: Likely Interests of Supporters / Opponents
...
-- New table: Shared Interests (foundation for compromise)
...
-- New table: Dispute Types (Empirical / Definitional / Values)
