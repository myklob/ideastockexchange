...
-- Add missing Argument columns (claim, famousQuote, quoteAuthor, quoteAuthorUrl, argumentScore
-- were in schema.prisma but never landed in any migration).
...
-- ValueRanking: value rankings per belief for supporters vs opponents.
...
-- SharedInterest: shared interests as a foundation for compromise.
...
-- DisputeType: Empirical / Definitional / Values dispute classification.
