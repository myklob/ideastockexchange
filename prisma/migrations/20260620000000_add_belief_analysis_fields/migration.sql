-- Add missing Argument columns for the April 2026 template
...
-- Add missing Belief columns for the April 2026 template
...
-- Add missing Compromise columns for the April 2026 template
...
-- Add missing ObjectiveCriteria columns for the April 2026 template
...
-- Add missing ValuesAnalysis columns for the April 2026 template
...
-- Add missing InterestsAnalysis columns for the April 2026 template
...
-- Create ValueRanking table (values analysis: how supporters/opponents rank values)
...
-- Create InterestEntry table (likely interests of supporters and opponents)
...
-- Create SharedInterest table (foundation for compromise)
...
-- Create DisputeType table (Empirical / Definitional / Values dispute classification)
