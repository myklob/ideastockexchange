-- Add falsifiability two-sided columns and header metadata to Belief
...
-- Add argument label, quote, and score columns to Argument
...
-- New tables added via db:push that never had migrations
...
-- Compromise: new template columns (sharedPremise, synthesis, whyDifficult)
...
-- ObjectiveCriteria: new template columns
