-- AlterTable: Belief — fields added to schema but never migrated
...
-- AlterTable: Compromise — new optional fields
...
-- AlterTable: ObjectiveCriteria — threshold / measurement columns
...
-- AlterTable: ValuesAnalysis — divergence-evidence columns
...
-- RedefineTables: Argument — add claim, famousQuote, quoteAuthor, quoteAuthorUrl, argumentScore
