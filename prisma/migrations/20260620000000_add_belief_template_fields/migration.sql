-- AlterTable: add new optional columns to Argument for the April 2026 template.
...
-- AlterTable: add new optional columns to ObjectiveCriteria.
...
-- AlterTable: add new optional columns to ValuesAnalysis.
...
-- AlterTable: add new optional columns to InterestsAnalysis.
...
-- AlterTable: add new optional columns to Compromise.
...
-- AlterTable: add new optional text columns to Belief for the April 2026 template.
