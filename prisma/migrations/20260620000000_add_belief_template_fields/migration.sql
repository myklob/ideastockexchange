-- Add Belief columns for the April 2026 template (falsifiability two-sided,
-- net score interpretation, and cross-reference header fields).
...
-- Add Argument columns for the April 2026 template (short label, quote, score).
...
-- Add ObjectiveCriteria columns for the April 2026 template.
...
-- Add ValuesAnalysis columns for the April 2026 template (divergence evidence, shift prompt).
...
-- Add InterestsAnalysis columns for the April 2026 template (primary conflict pair).
...
-- Add Compromise columns for the April 2026 template (three-column form).
