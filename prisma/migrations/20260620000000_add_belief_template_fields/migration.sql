-- AlterTable: add new Argument display fields and FK constraint (April 2026 template)
-- SQLite requires a table redefinition to add a FK constraint.
...
-- AlterTable: add new ObjectiveCriteria template fields
...
-- AlterTable: add new Compromise fields
...
-- AlterTable: add new InterestsAnalysis fields
...
-- AlterTable: add new ValuesAnalysis fields
...
-- AlterTable: add new belief template fields (April 2026 template)
