-- AlterTable Belief
-- Add two-sided Falsifiability Test columns and header metadata columns.
...
-- AlterTable Argument
-- Add short label, famous quote, and argument score columns from the new belief page template.
...
-- Add new template columns: how the criterion is measured, current status, and target threshold.
...
-- Add Best Compromise Solutions three-column form from the new template.
...
-- Add divergence evidence and "what would shift" columns from the new template.
...
-- Add Primary Conflict Pair columns from the new template.
