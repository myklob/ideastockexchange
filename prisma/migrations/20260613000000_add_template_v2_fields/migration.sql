-- Add missing ObjectiveCriteria columns from belief-analysis template v2
...
-- Add missing Argument columns from belief-analysis template v2
...
-- Add missing Belief columns from belief-analysis template v2
...
-- Add missing Compromise columns from belief-analysis template v2
...
-- Add missing ValuesAnalysis columns from template v2
...
-- Add missing InterestsAnalysis columns from template v2
