-- Add missing columns to Belief table (fields added to schema without a migration)
...
-- Add missing columns to Argument table (fields added to schema without a migration)
...
-- Add missing columns to ObjectiveCriteria table
...
-- Add missing columns to ValuesAnalysis table
...
-- Add missing columns to Compromise table
...
-- Add missing columns to InterestsAnalysis table
