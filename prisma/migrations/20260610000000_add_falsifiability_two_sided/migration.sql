-- AlterTable Belief: two-sided Falsifiability Test + net score interpretation + related-belief links
...
-- AlterTable Argument: label, quote, and displayed score
...
-- AlterTable InterestsAnalysis: primary-pair supporter/opponent fields
...
-- AlterTable Compromise: three-column form fields
