-- Sync schema fields that were added via db push without migrations.
...
-- RedefineTables (fix Argument table to include claim/famousQuote/quoteAuthor fields missing from earlier migration)
