-- Add schema fields that were added to schema.prisma without a corresponding migration.

-- Belief: two-sided Falsifiability Test, Net Score interpretation, header metadata
...
-- InterestsAnalysis: primary-pair debate fields
...
-- ValuesAnalysis: divergence-evidence fields
...
-- Argument: label/quote/score fields (SQLite requires table-redefinition to add nullable columns via PRAGMA)
...
-- New tables for Values, Interests, and Dispute analysis
