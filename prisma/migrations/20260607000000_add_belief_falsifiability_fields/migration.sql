-- AlterTable Belief: two-sided Falsifiability Test, net score interpretation, header metadata
...
-- AlterTable Argument: argument label, quote, author, display score
...
-- AlterTable Compromise: three-column Best Compromise form (shared premise, synthesis, why difficult)
...
-- AlterTable ObjectiveCriteria: how-to-measure, current status, and target threshold
...
-- AlterTable ValuesAnalysis: divergence evidence and shift prompt
...
-- CreateTable ValueRanking: Shared Values, Different Rankings rows
...
-- CreateTable InterestEntry: Likely Interests of Supporters/Opponents rows
...
-- CreateTable SharedInterest: Shared Interests rows
...
-- CreateTable DisputeType: Dispute Types rows
