-- AlterTable Belief: add missing scalar columns
...
-- AlterTable Argument: add missing scalar columns
...
-- AlterTable ObjectiveCriteria: add missing scalar columns
...
-- AlterTable ValuesAnalysis: add missing scalar columns
...
-- AlterTable InterestsAnalysis: add missing scalar columns
...
-- AlterTable Compromise: add missing scalar columns
