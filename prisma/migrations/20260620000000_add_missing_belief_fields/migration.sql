-- Add two-sided falsifiability fields, net score interpretation, and
-- related/supports belief metadata to the Belief table.
...
-- Add argument label, quote, and score fields to the Argument table.
...
-- Add new template columns to Compromise.
...
-- Add new template columns to ValuesAnalysis.
...
-- Add new template columns to InterestsAnalysis.
...
-- Add new template columns to ObjectiveCriteria.
...
-- CreateTable: Values & Interests analysis tables (new template).
