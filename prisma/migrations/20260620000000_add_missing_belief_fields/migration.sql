-- Comprehensive migration: fields added to schema without corresponding migrations.

-- Belief: two-sided Falsifiability Test, net score interpretation, related/supports labels
...
-- Argument: short label, famous quote attribution, optional displayed score
...
-- ObjectiveCriteria: measurement methodology and current vs target status
...
-- ValuesAnalysis: divergence evidence and shift conditions
...
-- InterestsAnalysis: primary supporter/opponent pair fields
...
-- Compromise: structured convergence fields
...
-- CreateTable: ValueRanking (value-prioritization rows per belief)
...
-- CreateTable: InterestEntry (per-side interest rows for the Interests section)
...
-- CreateTable: SharedInterest (shared interests across supporters and opponents)
...
-- CreateTable: DisputeType (empirical / definitional / values dispute classification)
