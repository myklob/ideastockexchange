-- Add columns present in Prisma schema but missing from prior migrations

-- Belief table: new template fields
...
-- Argument table: label, quote, and score fields
...
-- ObjectiveCriteria table: measurement columns
...
-- ValuesAnalysis table: divergence evidence columns
...
-- InterestsAnalysis table: primary conflict pair columns
...
-- Compromise table: new template columns
...
-- New tables missing from all prior migrations
