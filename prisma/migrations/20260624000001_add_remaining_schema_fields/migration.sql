-- ObjectiveCriteria: new-template columns (how measured, current status, target threshold).
...
-- ValuesAnalysis: divergence evidence and "what would shift" prompt.
...
-- Compromise: three-column Best Compromise Solutions form (new template).
