-- New columns on Argument for the April 2026 template (short label, famous
-- quote, author attribution, and displayed argument score).
...
-- New columns on Belief for the April 2026 template (falsifiability, score
-- interpretation, related/supports headers, interest/values sections).
...
-- New tables for Values / Interests sections of the belief page template.
...
-- New columns on Compromise for the April 2026 template (three-column form).
...
-- New columns on ObjectiveCriteria for the April 2026 template.
...
-- New columns on ValuesAnalysis for the April 2026 template.
...
-- New columns on InterestsAnalysis (Primary Conflict Pair) for the April 2026 template.
