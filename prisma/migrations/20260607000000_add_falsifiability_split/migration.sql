-- Add columns/tables present in schema.prisma but missing from earlier migrations.
...
-- Argument table: new display/attribution columns
...
-- ValueRanking: per-belief value priority table (Supporters vs Opponents)
...
-- InterestEntry: likely interests of supporters / opponents
...
-- SharedInterest: foundation for compromise rows
...
-- DisputeType: Empirical / Definitional / Values classification rows
