-- Add missing columns to Argument
...
-- Add missing columns to Compromise
...
-- Add missing columns to ObjectiveCriteria
...
-- Add missing scalar columns to Belief
...
-- Add missing columns to ValuesAnalysis
...
-- Add missing columns to InterestsAnalysis
