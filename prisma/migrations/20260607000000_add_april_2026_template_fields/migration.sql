-- April 2026 belief-page template: new columns and tables.

-- AlterTable Belief: two-sided Falsifiability Test, header metadata, net score interpretation.
...
-- AlterTable Argument: claim label, famous quote, argument score.
...
-- AlterTable ObjectiveCriteria: measurement columns.
...
-- AlterTable Compromise: three-column form columns.
