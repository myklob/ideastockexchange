-- Belief scalar fields added to schema without a matching migration.
...
-- Argument scalar fields added to schema without a matching migration.
...
-- New relational tables for the Values & Interests section (new template).
...
-- ObjectiveCriteria columns added to schema without a matching migration.
...
-- ValuesAnalysis columns added to schema without a matching migration.
...
-- InterestsAnalysis columns added to schema without a matching migration.
...
-- Compromise columns added to schema without a matching migration.
