-- Add missing Belief columns added to schema without a migration.
...
-- Add missing Argument columns and FK constraint for importanceBeliefId.
...
-- Create missing tables added to schema without a migration.
