-- AlterTable Belief: add new template columns
...
-- AlterTable Argument: add display columns from new template
...
-- AlterTable ValuesAnalysis: add divergence evidence and shift columns
...
-- AlterTable InterestsAnalysis: add primary conflict pair columns
...
-- AlterTable Compromise: add three-column form columns
