...
-- Add nuance fields to Compromise.
...
-- Add primary-pair fields to InterestsAnalysis.
...
-- Add measurement fields to ObjectiveCriteria.
...
-- Add divergence-evidence fields to ValuesAnalysis.
...
-- Add label and display fields to Argument (added to schema after add_claim_strength rewrote the table).
