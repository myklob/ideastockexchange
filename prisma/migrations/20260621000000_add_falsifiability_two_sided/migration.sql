-- AlterTable: add new Argument fields from the April 2026 template.
...
-- AlterTable: add new Belief fields from the April 2026 template.
...
-- AlterTable: add new ObjectiveCriteria fields from the April 2026 template.
...
-- AlterTable: add new ValuesAnalysis fields from the April 2026 template.
...
-- AlterTable: add new Compromise fields from the April 2026 template.
...
-- AlterTable: add new InterestsAnalysis fields from the April 2026 template.
