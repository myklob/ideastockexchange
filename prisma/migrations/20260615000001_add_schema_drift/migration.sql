-- Add scalar fields pushed via `prisma db push` without migrations,
-- and create new tables that the schema defines but migrations never created.

-- Argument: short label, quote, and computed score columns
...
-- ObjectiveCriteria: measurement columns from April 2026 template
...
-- InterestsAnalysis: primary conflict pair fields
...
-- New tables from April 2026 belief-analysis template
...
-- Compromise: three-column Best Compromise Solutions (new template)
