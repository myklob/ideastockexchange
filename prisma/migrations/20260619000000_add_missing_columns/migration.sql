-- AlterTable: Falsifiability test (two-sided), net score interpretation, related/supporting belief labels
...
-- AlterTable: Common-ground Compromise sub-fields
...
-- AlterTable: Primary pair on InterestsAnalysis
...
-- AlterTable: Objective criteria measurement fields
...
-- AlterTable: Values analysis divergence evidence
...
-- RedefineTables: Argument — add claim/quote fields missing from migration chain
