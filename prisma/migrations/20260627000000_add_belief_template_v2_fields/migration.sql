-- AlterTable Belief
-- Add fields introduced in the April 2026 template update that were added to
-- schema.prisma but never had a corresponding migration.
...
-- AlterTable Argument
-- Add argument cell display fields (short label, famous quote, score column).
...
-- Add measurement columns introduced in the April 2026 template.
...
-- Add three-column best-compromise form (shared premise, synthesis, why difficult).
...
-- Add divergence evidence and ranking-shift prompt from the April 2026 template.
...
-- Add primary conflict pair columns (two interests, validity, claim, driver).
