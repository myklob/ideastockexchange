-- AlterTable: missing Argument scalar columns
...
-- AlterTable: missing Belief scalar columns
...
-- AlterTable: missing ObjectiveCriteria columns (new template)
...
-- AlterTable: missing Compromise columns (new template)
...
-- AlterTable: missing InterestsAnalysis columns (Primary Conflict Pair)
...
-- AlterTable: missing ValuesAnalysis columns (new template)
