-- AlterTable: Belief fields added to schema after last migration
...
-- AlterTable: Argument fields added to schema after last migration
...
-- AlterTable: ObjectiveCriteria fields added to schema after last migration
...
-- AlterTable: ValuesAnalysis fields added to schema after last migration
...
-- AlterTable: InterestsAnalysis fields added to schema after last migration
...
-- CreateTable: ValueRanking (entire table new)
...
-- CreateTable: InterestEntry (entire table new)
...
-- CreateTable: SharedInterest (entire table new)
...
-- AlterTable: Compromise fields added to schema after last migration
...
-- CreateTable: DisputeType (entire table new)
