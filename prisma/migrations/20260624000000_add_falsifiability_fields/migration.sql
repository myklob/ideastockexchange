-- Add new Compromise columns (three-column form from April 2026 template)
...
-- Add new ObjectiveCriteria columns
...
-- Add new ValuesAnalysis columns
...
-- Add new InterestsAnalysis columns
...
-- Create new InterestEntry table
...
-- Create new SharedInterest table
