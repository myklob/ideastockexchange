-- AlterTable Belief: falsifiability test split-fields and belief header metadata
...
-- AlterTable Compromise: synthesis and premise fields
...
-- AlterTable InterestsAnalysis: primary pair columns
...
-- AlterTable ObjectiveCriteria: measurement and threshold columns
...
-- RedefineTables Argument: add label, quote, and score columns + FK on importanceBeliefId
