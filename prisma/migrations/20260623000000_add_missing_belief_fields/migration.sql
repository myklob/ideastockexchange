-- Add missing Belief columns that exist in the schema but were never migrated.
...
-- Add missing Argument columns that exist in the schema but were never migrated.
...
-- Create missing tables for Values/Interests analysis.
...
-- Add missing ObjectiveCriteria columns (new template fields).
...
-- Add missing ValuesAnalysis columns (new template fields).
...
-- Add missing InterestsAnalysis columns (new template primary interest pair fields).
...
-- Add missing Compromise columns (new template fields).
