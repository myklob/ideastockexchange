...
INSERT INTO "new_Evidence" ("author", "beliefId", "conclusionRelevance", "createdAt", "description", "doi", "evidenceType", "evsScore", "id", "impactScore", "isbn", "linkageScore", "linkageScoreType", "pmid", "publicationDate", "replicationPercentage", "replicationQuantity", "retrievedByAgentId", "side", "sourceIndependenceWeight", "sourceUrl", "tierClaim", "tierVerified", "updatedAt", "verificationStatus") SELECT "author", "beliefId", "conclusionRelevance", "createdAt", "description", "doi", "evidenceType", "evsScore", "id", "impactScore", "isbn", "linkageScore", "linkageScoreType", "pmid", "publicationDate", "replicationPercentage", "replicationQuantity", "retrievedByAgentId", "side", "sourceIndependenceWeight", "sourceUrl", "tierClaim", "tierVerified", "updatedAt", "verificationStatus" FROM "Evidence";
DROP TABLE "Evidence";
