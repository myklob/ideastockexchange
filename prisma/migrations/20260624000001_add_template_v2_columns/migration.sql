-- ObjectiveCriteria: new template measurement/status/target columns
...
-- ValuesAnalysis: divergence evidence and shift prompt (new template)
...
-- InterestsAnalysis: Primary Conflict Pair columns (new template)
