-- AlterTable: Belief -- new template header/scoring fields
...
-- AlterTable: Compromise -- new template synthesis fields
...
-- RedefineTables: Argument -- add claim/quote/argumentScore columns
