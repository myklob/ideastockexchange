...
-- Add missing InterestsAnalysis columns (primary pair section).
...
-- Redefine Argument table to add new optional columns and wire importanceBeliefId FK properly.
...
-- CreateTable ValueRanking (Shared Values, Different Rankings section)
...
-- CreateTable InterestEntry (Likely Interests of Supporters / Opponents section)
...
-- CreateTable SharedInterest (Shared Interests foundation-for-compromise section)
...
-- CreateTable DisputeType (Dispute Types: Empirical / Definitional / Values)
