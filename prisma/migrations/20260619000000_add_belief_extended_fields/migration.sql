-- Add extended ObjectiveCriteria columns added to schema without a migration
...
-- Add extended ValuesAnalysis columns added to schema without a migration
...
-- Add extended InterestsAnalysis columns added to schema without a migration
...
-- Add extended Compromise columns added to schema without a migration
...
-- Add extended Argument columns added to schema without a migration
...
-- Add extended Belief columns added to schema without a migration
...
-- New tables for Values/Interests analysis (new template)
