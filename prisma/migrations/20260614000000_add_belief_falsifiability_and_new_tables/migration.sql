-- AlterTable Belief: add columns that were in schema but missing from migrations
...
-- AlterTable Argument: add columns that were in schema but missing from migrations
...
-- AlterTable ObjectiveCriteria: add columns that were in schema but missing from migrations
...
-- AlterTable ValuesAnalysis: add columns that were in schema but missing from migrations
...
-- AlterTable InterestsAnalysis: add columns that were in schema but missing from migrations
...
-- AlterTable Compromise: add columns that were in schema but missing from migrations
