-- Add falsifiability two-sided columns and net interpretation to Belief
...
-- Add argument label/quote/score columns to Argument
...
-- Add divergence evidence and shift prompt to ValuesAnalysis
...
-- Add Primary Conflict Pair columns to InterestsAnalysis
...
-- Add Best Compromise Solutions columns to Compromise
