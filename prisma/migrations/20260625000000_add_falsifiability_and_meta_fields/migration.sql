-- AlterTable Belief: add falsifiability confirm/falsify, netInterpretation, and header metadata fields
...
-- AlterTable Argument: add display label, famous quote, and argument score fields
...
-- AlterTable ObjectiveCriteria: add measurement details columns
