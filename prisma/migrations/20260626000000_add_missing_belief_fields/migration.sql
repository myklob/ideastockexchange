-- AlterTable Belief: columns added to schema.prisma without a migration.
...
-- AlterTable Argument: claim/quote/score display columns added without a migration.
...
-- AlterTable Compromise: synthesis columns added without a migration.
...
-- AlterTable ObjectiveCriteria: measurability columns added without a migration.
...
-- AlterTable ValuesAnalysis: divergence-evidence columns added without a migration.
...
-- AlterTable InterestsAnalysis: primary-conflict-pair columns added without a migration.
