-- AlterTable: Belief
-- New fields from the April 2026 template update.
...
-- AlterTable: Argument
-- Short label, famous quote, and argument score fields from new template.
...
-- How-to-measure and threshold columns from new template.
...
-- Divergence evidence and shift question from new template.
...
-- Primary Conflict Pair columns from new template.
...
-- Three-column form from new template.
