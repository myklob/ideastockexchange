-- April 2026 belief-page template: new tables and columns added across
-- Argument, Belief, Compromise, InterestsAnalysis, ObjectiveCriteria, ValuesAnalysis.

-- CreateTable: ValueRanking (Shared Values, Different Rankings table)
...
-- CreateTable: InterestEntry (Likely Interests of Supporters / Opponents)
...
-- CreateTable: DisputeType (Dispute Types table: Empirical / Definitional / Values)
...
-- AlterTable: Argument — new display columns for the two-sided scored table
...
-- AlterTable: Belief — new metadata / falsifiability fields
...
-- AlterTable: Compromise — three-column Best Compromise Solutions
...
-- AlterTable: InterestsAnalysis — Primary Conflict Pair fields
...
-- AlterTable: ObjectiveCriteria — How to Measure / Current Status / Target
...
-- AlterTable: ValuesAnalysis — Advertised vs. Actual Motivations + What Would Shift
