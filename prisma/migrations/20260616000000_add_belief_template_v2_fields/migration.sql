-- AlterTable: new Belief fields from April 2026 template restructuring
...
-- AlterTable: new Compromise fields
...
-- AlterTable: primary conflict pair fields on InterestsAnalysis
...
-- AlterTable: measurement columns on ObjectiveCriteria
...
-- AlterTable: values divergence fields on ValuesAnalysis
...
-- CreateTable: Shared Values, Different Rankings table
...
-- CreateTable: Likely Interests rows for Supporters / Opponents
...
-- RedefineTables: add claim/quote/argumentScore columns to Argument
