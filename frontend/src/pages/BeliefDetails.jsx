...
import AddContributorForm from '../components/Contributors/AddContributorForm';
...
const BeliefDetails = () => {
  ...
  const [activeTab, setActiveTab] = useState('all'); // all, supporting, opposing, assumptions, contributors
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="flex items-center space-x-2 mb-6 border-b border-gray-200">
                ...
                >
                  Contributors ({belief.statistics?.contributorCount || 0})
                </button>
              </div>
                  ...
                  {showAddContributor && (
                    <AddContributorForm
                      ...
                      onSuccess={() => {
                        ...
                        // The ContributorList component will automatically refresh
                      }}
