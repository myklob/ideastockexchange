...
type FallacyRecord = { impactOnValidity: number }
type ContradictionRecord = { impactOnIntegrity: number }
type BookRecord = { id: string; title: string; author: string; logicalValidityScore: number; beliefImpactWeight: number; socialShares: number; authorProfile: AuthorRecord | null }
type AuthorRecord = { id: string; totalPredictions: number; accuratePredictions: number }
type PredictionRecord = { bookId: string }
type BookForGap = { id: string; title: string; author: string; logicalValidityScore: number; beliefImpactWeight: number; socialShares: number }

const db = prisma as unknown as {
  fallacy: {
    create: (args: unknown) => Promise<Record<string, unknown>>
    findMany: (args: unknown) => Promise<FallacyRecord[]>
  }
  book: {
    findUnique: (args: unknown) => Promise<BookRecord | null>
    update: (args: unknown) => Promise<Record<string, unknown>>
    findMany: (args: unknown) => Promise<BookForGap[]>
  }
  contradiction: {
    create: (args: unknown) => Promise<Record<string, unknown>>
    findMany: (args: unknown) => Promise<ContradictionRecord[]>
  }
  evidence: {
    create: (args: unknown) => Promise<Record<string, unknown>>
    update: (args: unknown) => Promise<Record<string, unknown>>
  }
  metaphor: { create: (args: unknown) => Promise<Record<string, unknown>> }
  prediction: {
    create: (args: unknown) => Promise<Record<string, unknown>>
    update: (args: unknown) => Promise<PredictionRecord>
  }
  author: { update: (args: unknown) => Promise<Record<string, unknown>> }
}
